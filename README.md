...
2. [regressão + stack] Mesmo do item 1 porem com stacking ensembles
3. [identificacao] Identificacao de sistemas tentando extrapolar por sim livre um dado perfil num dado poco
